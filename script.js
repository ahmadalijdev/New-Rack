...
const products = [
...

  {
    ...
    sizes: ["S", "M", "L", "XL"],
    description:
      "A clean classic shirt with a contemporary everyday fit.",
    images: [
      "images/men-item-2a.png",
      "images/men-item-2b.png",
      "images/men-item-2c.png"
    ]
  },

  {
    ...
    sizes: ["M", "L", "XL"],
    description:
      "A structured modern jacket built for a sharp contemporary look.",
    images: [
      "images/men-item-3a.png",
      "images/men-item-3b.png",
      "images/men-item-3c.png"
    ]
  },

  {
    ...
    sizes: ["S", "M", "L", "XL"],
    description:
      "Relaxed-fit pants designed for comfort without losing structure.",
    images: [
      "images/men-item-4a.png",
      "images/men-item-4b.png"
    ]
  },

  {
    ...
    description:
      "Minimal everyday sneakers designed to work with any wardrobe.",
    images: [
      "images/men-item-5a.png",
      "images/men-item-5b.png"
    ]
  },

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A minimal timepiece with a clean design and timeless finish.",
    images: [
      "images/men-item-6a.png",
      "images/men-item-6b.png"
    ]
  },

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A refined leather belt designed to complement everyday outfits.",
    images: [
      "images/men-item-7a.png",
      "images/men-item-7b.png"
    ]
  },

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A compact minimal wallet designed for everyday essentials.",
    images: [
      "images/men-item-8a.png",
      "images/men-item-8b.png"
    ]
  },
...

  {
    ...
    sizes: ["XS", "S", "M", "L"],
    description:
      "A contemporary top with a clean silhouette and versatile styling.",
    images: [
      "images/women-item-1a.png",
      "images/women-item-1b.png",
      "images/women-item-1c.png"
    ]
  },

  {
    ...
    sizes: ["XS", "S", "M", "L"],
    description:
      "A relaxed everyday top designed for effortless comfort.",
    images: [
      "images/women-item-2a.png",
      "images/women-item-2b.png"
    ]
  },

  {
    ...
    sizes: ["S", "M", "L"],
    description:
      "A structured jacket that brings a sharp contemporary finish.",
    images: [
      "images/women-item-3a.png",
      "images/women-item-3b.png"
    ]
  },

  {
    id: "women-item-4",
    name: "Wide Leg Bottoms",
    section: "women",
    category: "BOTTOMS",
    filters: ["bottoms"],
    price: 6490,
    ...
    sizes: ["XS", "S", "M", "L"],
    description:
      "Wide-leg bottoms with a relaxed shape and modern silhouette.",
    images: [
      "images/women-item-4a.png",
      "images/women-item-4b.png"
    ]
  },

  {
    ...
    description:
      "Clean everyday shoes designed for comfort and simple styling.",
    images: [
      "images/women-item-5a.png",
      "images/women-item-5b.png"
    ]
  },

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A practical everyday bag with a clean contemporary design.",
    images: [
      "images/women-item-6a.png",
      "images/women-item-6b.png"
    ]
  },

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A minimal accessory designed to add a refined finishing touch.",
    images: [
      "images/women-item-7a.png",
      "images/women-item-7b.png"
    ]
  },

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A statement accessory designed to stand out without excess.",
    images: [
      "images/women-item-8a.png",
      "images/women-item-8b.png"
    ]
  },
  ...
  {
    id: "kids-item-1",
    name: "Kids Everyday Top",
    section: "kids",
    category: "TOPS",
    filters: ["boys", "new", "tops"],
    price: 2850,
    color: "Blue",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "A comfortable everyday top designed for active young wearers.",
    images: [
      "images/kids-item-1a.png",
      "images/kids-item-1b.png"
    ]
  },

  {
    id: "kids-item-2",
    name: "Girls Everyday Top",
    section: "kids",
    category: "TOPS",
    filters: ["girls", "new", "tops"],
    price: 2450,
    color: "Pink",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "A simple everyday top designed for comfort and easy styling.",
    images: [
      "images/kids-item-2a.png",
      "images/kids-item-2b.png"
    ]
  },

  {
    id: "kids-item-3",
    name: "Boys Casual Top",
    section: "kids",
    category: "TOPS",
    filters: ["boys", "new", "tops"],
    price: 1650,
    ...
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "A casual top designed for everyday comfort and movement.",
    images: [
      "images/kids-item-3a.png",
      "images/kids-item-3b.png"
    ]
  },

  {
    id: "kids-item-4",
    name: "Girls Casual Jacket",
    section: "kids",
    category: "JACKETS",
    filters: ["girls", "new", "jackets"],
    price: 3250,
    color: "Beige",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "A lightweight casual jacket with a clean contemporary look.",
    images: [
      "images/kids-item-4a.png",
      "images/kids-item-4b.png"
    ]
  },

  {
    id: "kids-item-5",
    name: "Boys Everyday Bottoms",
    section: "kids",
    category: "BOTTOMS",
    filters: ["boys", "new", "bottoms"],
    price: 2150,
    color: "Black",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "Comfortable everyday bottoms designed for active days.",
    images: [
      "images/kids-item-5a.png",
      "images/kids-item-5b.png"
    ]
  },

  {
    id: "kids-item-6",
    name: "Girls Everyday Bottoms",
    section: "kids",
    category: "BOTTOMS",
    filters: ["girls", "new", "bottoms"],
    price: 2350,
    color: "Black",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "A comfortable everyday fit with a simple contemporary finish.",
    images: [
      "images/kids-item-6a.png",
      "images/kids-item-6b.png"
    ]
  },

  {
    ...
    section: "kids",
    category: "SETS",
    filters: ["boys", "new", "sets"],
    price: 2950,
    color: "Blue",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
    description:
      "A coordinated everyday set designed for comfort and easy styling.",
    images: [
      "images/kids-item-7a.png",
      "images/kids-item-7b.png"
    ]
  },

  {
    ...
    section: "kids",
    category: "ACCESSORIES",
    filters: ["girls", "accessories"],
    price: 2950,
    color: "Mixed",
    sizes: ["STANDARD"],
    description:
      "A simple accessory selection designed to complete everyday looks.",
    images: [
      "images/kids-item-8a.png",
      "images/kids-item-8b.png"
    ]
  },
...

  {
    ...
    sizes: ["STANDARD"],
    description:
      "A practical everyday bag with a clean contemporary silhouette.",
    images: [
      "images/accessories-item-1a.png",
      "images/accessories-item-1b.png"
    ]
  },

  {
    id: "accessories-item-2",
    name: "Classic Watch",
    section: "accessories",
    category: "WATCHES",
    filters: ["watches", "new"],
    ...
    sizes: ["STANDARD"],
    description:
      "A timeless watch designed around a clean minimal aesthetic.",
    images: [
      "images/accessories-item-2a.png",
      "images/accessories-item-2b.png"
    ]
  },

  {
    id: "accessories-item-3",
    name: "Modern Sunglasses",
    section: "accessories",
    category: "SUNGLASSES",
    filters: ["sunglasses", "new"],
    price: 2990,
    color: "Black",
    sizes: ["STANDARD"],
    description:
      "Modern sunglasses with a clean frame and everyday versatility.",
    images: [
      "images/accessories-item-3a.png",
      "images/accessories-item-3b.png"
    ]
  },

  {
    id: "accessories-item-4",
    name: "Classic Belt",
    section: "accessories",
    category: "BELTS",
    filters: ["belts"],
    ...
    sizes: ["STANDARD"],
    description:
      "A classic belt designed to complete everyday outfits.",
    images: [
      "images/accessories-item-4a.png",
      "images/accessories-item-4b.png"
    ]
  },

  {
    id: "accessories-item-5",
    name: "Leather Wallet",
    section: "accessories",
    category: "WALLETS",
    filters: ["wallets"],
    ...
    sizes: ["STANDARD"],
    description:
      "A compact leather wallet designed around practical minimalism.",
    images: [
      "images/accessories-item-5a.png",
      "images/accessories-item-5b.png"
    ]
  },

  {
    id: "accessories-item-6",
    name: "Shoulder Bag",
    section: "accessories",
    category: "BAGS",
    filters: ["bags"],
    ...
    sizes: ["STANDARD"],
    description:
      "A versatile shoulder bag designed for everyday use.",
    images: [
      "images/accessories-item-6a.png",
      "images/accessories-item-6b.png"
    ]
  },

  {
    id: "accessories-item-7",
    ...
    sizes: ["STANDARD"],
    description:
      "Minimal jewelry designed to add a subtle refined detail.",
    images: [
      "images/accessories-item-7a.png",
      "images/accessories-item-7b.png"
    ]
  },

  {
    id: "accessories-item-8",
    ...
    sizes: ["STANDARD"],
    description:
      "A premium everyday frame with a clean modern profile.",
    images: [
      "images/accessories-item-8a.png",
      "images/accessories-item-8b.png"
    ]
  }
];
